  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl w-full">
        <Link href={`/${locale}/character`} className="card-medieval-dark p-6 text-center hover:shadow-tome-hover transition-shadow">
        ...
        <Link href={`/${locale}/compendium`} className="card-medieval-dark p-6 text-center hover:shadow-tome-hover transition-shadow">
        ...
        <Link href={`/${locale}/master`} className="card-medieval-dark p-6 text-center hover:shadow-tome-hover transition-shadow">
