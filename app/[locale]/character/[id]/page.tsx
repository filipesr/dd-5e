  ...
  if (!character) {
    return (
      <main className="flex min-h-screen items-center justify-center flex-col gap-4">
        ...
        <Button variant="ghost" onClick={() => router.push(`/${locale}/character`)} className="flex items-center gap-2">
          <ArrowLeft size={16} />
          {t.common.back}
        </Button>
      </main>
    ...
    <main className="min-h-screen p-4 max-w-3xl mx-auto space-y-3 pb-16">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          <Button variant="ghost" size="sm" onClick={() => router.push(`/${locale}/character`)} className="flex items-center gap-2">
            <ArrowLeft size={16} />
            {t.common.back}
          </Button>
